...
冻结纪律(harden-eval-implementation-decoupling):词典与 prompt/评估期望共同演化时
必须显式递增 SECTION_SYNONYMS_VERSION,冻结测试锁定内容防无人察觉漂移。
"""
...
SECTION_SYNONYMS: dict[str, list[str]] = {
    ...
    "市场情绪": ["市场情绪", "情绪分析", "资金面", "市场情绪面", "情绪", "舆情", "舆情分析"],
